...
export const TameStats = () => (
    ...
    <Card title="Quick Visual — What Matters For What Role">
    <div className="overflow-x-auto">
    <table className="w-full text-sm text-left">
    <thead className="text-xs text-slate-400 uppercase bg-slate-900/50">
    <tr>
    <th className="px-4 py-3">Role</th>
    <th className="px-4 py-3 text-emerald-400">#1 Stat</th>
    <th className="px-4 py-3 text-blue-400">#2 Stat</th>
    <th className="px-4 py-3 text-amber-400">#3 Stat</th>
    </tr>
    </thead>
    <tbody className="divide-y divide-slate-800">
    <tr className="bg-slate-900/20"><td className="px-4 py-2 font-bold">Harvester</td><td className="px-4 py-2">Melee</td><td className="px-4 py-2">Weight</td><td className="px-4 py-2">Health</td></tr>
    <tr className="bg-slate-900/40"><td className="px-4 py-2 font-bold">Transport</td><td className="px-4 py-2">Weight</td><td className="px-4 py-2">Stamina</td><td className="px-4 py-2">Health</td></tr>
    <tr className="bg-slate-900/20"><td className="px-4 py-2 font-bold">Combat Mount</td><td className="px-4 py-2">Melee</td><td className="px-4 py-2">Health</td><td className="px-4 py-2">Stamina</td></tr>
    <tr className="bg-slate-900/40"><td className="px-4 py-2 font-bold">Boss Killer</td><td className="px-4 py-2">Health</td><td className="px-4 py-2">Melee</td><td className="px-4 py-2 text-slate-500">(stop)</td></tr>
    <tr className="bg-slate-900/20"><td className="px-4 py-2 font-bold">Tank/Soak</td><td className="px-4 py-2">Health</td><td className="px-4 py-2">Melee</td><td className="px-4 py-2">Stamina</td></tr>
    <tr className="bg-slate-900/40"><td className="px-4 py-2 font-bold">Healer (Daeodon)</td><td className="px-4 py-2">Health</td><td className="px-4 py-2">Food</td><td className="px-4 py-2">Weight</td></tr>
    <tr className="bg-slate-900/20"><td className="px-4 py-2 font-bold">Cave Mount</td><td className="px-4 py-2">Melee</td><td className="px-4 py-2">Health</td><td className="px-4 py-2">Stamina</td></tr>
    <tr className="bg-slate-900/40"><td className="px-4 py-2 font-bold">Flyer</td><td className="px-4 py-2">Stamina</td><td className="px-4 py-2">Weight</td><td className="px-4 py-2">Health</td></tr>
    </tbody>
    </table>
    </div>
    </Card>
